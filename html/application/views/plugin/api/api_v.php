	...
	<script>
		...
		$(document).ready(function(){
			...
			$(document).on('click', 'button[type="submit"]', function(){
                ...
                ajax_config.url = api_parent.find('.endpoint').text().replace(/\s/g, '');
                ...
                if(ajax_config.headers.length > 0) {
                    request_data_str += '\n########################## header ########################################\n\n';
                    ...
                    if($(row1).attr("sub_data") == 1){
                        ...
                        $.each($(row1).children('div[sub_data]'), function(index2, row2){
                            ...
                            if($(row2).attr("sub_data") == 1){
                                ...
                                $.each($(row2).children('.row'), function(index3, row3){
                                    var row_div3 = $(row3).children('div');
				...
				<div class="api-wrap <?= $api_item['method_name']; ?>">
					...
					<section class="api-box">
						...
						<div class="endpoint">
							...
							<?php $api_url = $base_url . $api_item['method_name'] . $api_item['url_parameter'];?>

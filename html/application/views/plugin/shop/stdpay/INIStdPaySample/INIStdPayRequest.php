                                        ...
                                        <td style="text-align:left;">
                                            <form id="SendPayForm_id" name="" method="POST" >
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><b>returnUrl</b> :
                                                    <br/><input  style="width:100%;" name="returnUrl" value="<?php echo $siteDomain ?>/INIStdPayReturn" >
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><input  style="width:100%;" name="gopaymethod" value="Card:HPP" >
                                                    <br/><br/>
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><input style="width:100%;" name="closeUrl" value="<?php echo $siteDomain ?>/close" >
                                                    ...
                                                    <br/><input style="width:100%;" name="popupUrl" value="<?php echo $siteDomain ?>/popup" >

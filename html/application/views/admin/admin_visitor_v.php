...
<div class="col-md-9">
    <h3>현재 접속자 : <?=count($current_visitor_list)?>명</h3>
    ...
    <div style="margin-top:30px !important;">
        ...
        <table class="table table-bordered" style="margin-bottom:10px !important;">
            ...
            <? if (sizeof($current_visitor_list)) { ?>
                <? foreach ($current_visitor_list as $list) { ?>
                    <tr>
                        <td class="center"><input type="checkbox" name="no[]" value="<?= $list['no'] ?>"></td>
                        <td class="center">
                            <?if($list['user_data']){?>
                                <?= unserialize($list['user_data'])['mb_id']?>
                            <?}else{?>
                                <?= $list['session_id'] ?>
                            <?}?>
                        </td>
            ...
            <div class="clearfix">
                ...
                <div class="span4 pull-left">
                    <div class="input-group">
                        <input name="searchValue" class="form-control input-sm" maxlength="15"
                               value="<?= @$searchValue ?>">
        ...
        <p style = "color:red; font-weight:bold;">total : <?= $cnt['total_rows'] ?></p>
...
<div class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div>
                <form id="update_mb_data" class="form-horizontal" method="post"
                      action="/admin/member/admin_member_update" novalidate="novalidate">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="mb_password"><span
                                    class="glyphicon glyphicon-exclamation-sign"></span> 비밀번호</label>
                        <div class="col-md-9">
                            <input type="password" id="mb_password" name="mb_password" class="form-control span3"
                                   maxlength="20"> 3 ~ 20자
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="mb_password_re"><span
                                    class="glyphicon glyphicon-exclamation-sign"></span> 비밀번호 확인</label>
                        <div class="col-md-9">
                            <input type="password" id="mb_password_re" name="mb_password_re" class="form-control span3"
                                   maxlength="20"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="mb_name"><span
                                    class="glyphicon glyphicon-exclamation-sign"></span> 이름</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="mb_hp"><span
                                    class="glyphicon glyphicon-phone"></span>휴대폰</label>
                        <div class="col-md-3">
                            <input type="tel" id="mb_hp" name="mb_hp" class="form-control" maxlength="14" value=""/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="reg_mb_email"><span
                                    class="glyphicon glyphicon-exclamation-sign"></span> 이메일</label>
                        <div class="col-md-4">
                            <div class="input-group">
                                <span class="input-group-addon"><span
                                            class="glyphicon glyphicon-envelope"></span></span>
                                <input type="email" id="reg_mb_email" name="mb_email" class="form-control"
                                       maxlength="60" value="">
                            </div>
                        </div>
                        <div class="col-md-5">
                            <button type="button" id="btn_email" class="btn btn-info" data-loading-text="확인 중...">중복확인
                            </button>
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="reg_mb_point"><span
                                    class="glyphicon glyphicon-gift"></span> 포인트</label>
                        <div class="col-md-4">

                                ...
                                <td style="text-align:left;">
                                    <form id="SendPayForm_id" name="" method="POST">
                                        ...
                                        <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                            ...
                                            <br/><b>oid</b> :
                                            <br/><input style="width:100%;" name="oid"
                                            ...
                                            <br/><b>buyername</b> :
                                            <br/><input style="width:100%;" name="buyername" value="임지호">

                                            <br/><b>buyertel</b> :
                                            <br/><input style="width:100%;" name="buyertel" value="010-9582-8912">

                                            <br/><b>buyeremail</b> :
                                            <br/><input style="width:100%;" name="buyeremail"
                                                        value="jiho8912@naver.com">


                                            <!-- <br/><b>timestamp</b> : -->
                                            <input type="text" style="width:100%;" name="timestamp"
                                            ...
                                            <br/><b>returnUrl</b> :
                                            <br/><input style="width:100%;" name="returnUrl"
                                                        value="<?php echo $siteDomain ?>/INIStdPayReturn">
                                        ...
                                        <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                            ...
                                            <br/>acceptmethod ex)
                                            CARDPOINT:SLIMQUOTA(코드-개월:개월):no_receipt:va_receipt:vbanknoreg(0):vbank(20150425):va_ckprice:vbanknoreg:
                                            <br/>KWPY_TYPE(0):KWPY_VAT(10|0) 기타 옵션 정보 및 설명은 연동정의보 참조 구분자 ":"
                                            <br/><input style="width:100%;" name="acceptmethod"
                                        ...
                                        <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                            ...
                                            <br/><b>closeUrl</b> : payViewType='overlay','popup'시 취소버튼 클릭시 창닥기 처리
                                            URL(가맹점에 맞게 설정)
                                            <br/>close.jsp 샘플사용(생략가능, 미설정시 사용자에 의해 취소 버튼 클릭시 인증결과 페이지로 취소 결과를 보냅니다.)
                                            <br/><input style="width:100%;" name="closeUrl"
                                                        value="<?php echo $siteDomain ?>/close">

                                            <br/><b>popupUrl</b> : payViewType='popup'시 팝업을 띄울수 있도록 처리해주는 URL(가맹점에 맞게
                                            설정)
                                            <br/>popup.jsp 샘플사용(생략가능,payViewType='popup'으로 사용시에는 반드시 설정)
                                            <br/><input style="width:100%;" name="popupUrl"
                                                        value="<?php echo $siteDomain ?>/popup">
                                        ...
                                        <div style="border:2px #cccccc solid;padding:10px;background-color:#f3f3f3;">
                                            ...
                                            <br/><input style="width:100%;" name="nointerest"
                                                        value="<?php echo $cardNoInterestQuota ?>">

                                            <br/><b>quotabase</b> : 할부 개월
                                            <br/>ex) 2:3:4
                                            <br/><input style="width:100%;" name="quotabase"
                                                        value="<?php echo $cardQuotaBase ?>">
